...
<li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <h2 class="table-striped">Cetak Laporan Berdasarkan Stok Barang</h2>
            <form action="tampillapbarang.jsp" method="get">
                    <input type="number" placeholder="Stok<=" name="jumlah" value="0" />
                     <input type="submit" class="btn btn-primary" value="Cetak Laporan Barang" />
            </form>
