...
<table border="0">
    <from action="BarangServlet" method="post" onsubmit="retun validasi_inputBarang(this)">
            ...
            <c:forEach var="rowbrg" items="${querybarang.rowsByIndex}">
                <tr class="isi">
                    ...
                    <td valign='top'><a href='BarangServlet?aksi=Hapus&kode=${rowbrg[0]}'>Hapus</a>
                        <a href='barang.jsp?halaman=tampilbrg&aksi=GANTI&kd_brg=${rowbrg[0]}
                           &nm_brg=${rowbrg[1]}&harga=${rowbrg[2]}&stok=${rowbrg[3]}'>Edit</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
